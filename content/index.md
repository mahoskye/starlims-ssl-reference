...
| [Classes](reference/classes/index.md) | 28 | Object types for data tables, dictionaries, regex, email, and system services |
...
| [Special Forms](reference/special-forms/index.md) | 6 | Language constructs: constructor, base, me, code-block, access modifiers, code organization |
...
Every element page includes complete parameter details, return types, exception conditions with messages, best practices, and working code examples.

This documentation is for SSL developers working in STARLIMS environments who need accurate behavioral details for the functions, classes, and language features available to them.
